...
// .wrangler/tmp/bundle-hOv6BB/checked-fetch.js
...
// .wrangler/tmp/bundle-hOv6BB/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-hOv6BB/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
app.post("/api/v1/signin", async (c) => {
  ...
  const jwt3 = await sign2({ id: user.id }, c.env.JWT_SECRET);
