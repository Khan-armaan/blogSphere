...
// .wrangler/tmp/bundle-SGV1Rf/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/Users/armaankhan/web-code/week-13/mediun/Backend/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/Users/armaankhan/web-code/week-13/mediun/Backend/prisma/schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// node_modules/@armaankhan0/common/dist/index.js
var require_dist = __commonJS({
  "node_modules/@armaankhan0/common/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// .wrangler/tmp/bundle-SGV1Rf/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-SGV1Rf/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
userRouter.post("/signup", async (c) => {
  ...
  const prisma = new import_edge.PrismaClient({
    ...
    // enviroment variable using c  context
  }).$extends(withAccelerate());
  try {
    const user = await prisma.user.create({
      //got back the user object from here
      data: {
        email: body.email,
    ...
    return c.json({
      jwt: token
      // signup request returning a jwt token
    });
  } catch (e) {
    console.log(e);
    c.status(403);
...
userRouter.post("/signin", async (c) => {
  ...
  const jwt4 = await sign2({ id: user.id }, c.env.JWT_SECRET);
  return c.json({ jwt: jwt4 });
});
